...
    console.log('validateOrderSession: Received waNumber:', waNumber);
    console.log('validateOrderSession: Received botNumber:', botNumber);
    
...
    
    // Log user data and state for debugging
    console.log('validateOrderSession: Found user in DB:', user ? user.waNumber : 'None');
    console.log('validateOrderSession: User state stage:', user?.state?.stage);
...
    console.log('/create-order: Received order for waNumber:', waNumber);
    console.log('/create-order: Order items:', orderItems);
